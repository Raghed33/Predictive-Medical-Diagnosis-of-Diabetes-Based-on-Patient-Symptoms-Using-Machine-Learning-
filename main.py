...
# Letting the user decide which dataset to use
print("Last ID for dataset1:2768")
print("Last ID for dataset2:4303, Note:(This dataset has more number of features)")

dataset_choice = input("Enter the dataset you want to test (1 or 2 ): ")
